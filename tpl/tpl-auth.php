...
<html lang="en">
  ...
  <head>
    <meta charset="UTF-8">
    <title>Interactive Sign in &amp; Sign up Auth Form</title>
...
<body>
    <div class="container" id="container">
        <div class="form-container sign-up-container" id="rigester">
            <form action="<?= site_url('auth.php?action=rigester') ?>" method="POST">
